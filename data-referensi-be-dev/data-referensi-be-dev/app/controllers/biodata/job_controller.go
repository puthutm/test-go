...
func GetJobs(c *fiber.Ctx) error {
	...
	query_results, total, err := models.GetJobs(filter, sortBy, sortDirection, page, pageSize)
	if err != nil {
...
func SearchJobs(c *fiber.Ctx) error {
	...
	query_results, err := models.SearchJobs(filter, sortBy, sortDirection, page, pageSize)
	if err != nil {
		return handlers.SendFailed(c, fiber.StatusOK, nil, helpers.GenerateRM("get", false))
	}
...
func ExportJobs(c *fiber.Ctx) error {
	return handlers.ControllerExport(c, "Jobs", models.ExportJobs)
}

func GetJob(c *fiber.Ctx) error {
	id := c.Params("id")
	query_result, err := models.GetJob(id)
	if err != nil {
...
func ImportJobs(c *fiber.Ctx) error {
	return handlers.ControllerImport(c, models.ImportJobs)
}
...
func GetTrashJobs(c *fiber.Ctx) error {
	...
	query_results, total, err := models.GetTrashJobs(filter, sortBy, sortDirection, page, pageSize)
	if err != nil {
		return handlers.SendFailed(c, fiber.StatusOK, nil, helpers.GenerateRM("get", false))
	}
