...
export const getAllListKrs = async (queryParam: QueryParamKrs): Promise<ApiResponse<KrsListData>> => {
    ...
    try {
        const response = await fetchApi(`/student/academic/filling-krs/pick?${params.toString()}`, {
            method: "GET",
            headers: {
