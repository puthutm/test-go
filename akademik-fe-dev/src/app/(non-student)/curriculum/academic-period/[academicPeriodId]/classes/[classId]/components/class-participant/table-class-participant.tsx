...
import { deleteClassParticipantForProgramHead } from "@/services/api/curriculum/academic-period/class-participant/delete-class-participant";
...
export const TableClassParticipant = ({
  ...
  const onDeleteAcademicSubject = async () => {
    ...
    const response = await deleteClassParticipantForProgramHead(
      classId,
