...
import { useGetClassParticipantByIdForProgramHead } from "@/services/api/curriculum/academic-period/class-participant/use-get-class-participant-by-id";
...
export const ModalDetailClassParticipant = ({
  ...
  const { data } = useGetClassParticipantByIdForProgramHead(
    classId,
