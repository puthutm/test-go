...
import { updateClassContractForProgramHead } from "@/services/api/curriculum/academic-period/class-contract/update-class-contract";
...
export const FormClassContract = ({
  ...
  const onSubmit = async (data: FormClassContractSchemaType) => {
    try {
      ...
      const response = await updateClassContractForProgramHead(
        classId,
        payload
      );
