...
import { createClassScheduleTemplate } from "@/services/api/curriculum/academic-period/class-schedule/create-class-schedulte-template";
import { updateClassScheduleTemplate } from "@/services/api/curriculum/academic-period/class-schedule/update-class-schedule-template";
