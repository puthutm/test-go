    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="d-flex gap-1 justify-content-center align-items-center">
          <Link
            href={`/settings/curriculum-year/${curriculumYearId}/subjects/${row.original.id}/edit`}
          >
            <Button
          ...
          <Link
            href={`/settings/curriculum-year/${curriculumYearId}/subjects/${row.original.id}/detail`}
          >
            <Button
              className="bg-transparent border-0 text-black p-0 fs-4"
              title="Detail"
