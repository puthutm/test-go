...
export const TableSubject = ({
  ...
  const { columns } = useColumnDefinitionSubject(curriculumYearId as string);
  ...
  return (
    <Row>
      ...
      />
      <Col>
        <div className="gap-2 d-flex flex-column w-100 gap-3 p-1">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex gap-2">
              <Link
                ...
                href={`/settings/curriculum-year/${curriculumYearId}/subjects/add`}
              >
