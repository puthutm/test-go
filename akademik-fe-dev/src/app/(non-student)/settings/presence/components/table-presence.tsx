...
import { useColumnPresenceSubject } from "./column-definition-presence";
...
export const TablePresence = ({
  data,
}: {
  data: ApiResponse<PaginationData<SubjectsPresence>>;
}) => {
  ...
  const { columns } = useColumnPresenceSubject();
