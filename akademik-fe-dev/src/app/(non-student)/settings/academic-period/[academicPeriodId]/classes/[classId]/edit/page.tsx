          ...
          <Card style={{ borderRadius: "8px" }}>
            <CardBody>
              {tabSearchParam === "class-detail" || !tabSearchParam ? (
                <ClassDetail params={params} detailClass={detailClass} />
              ) : null}
              ...
              {tabSearchParam === "class-contract" ? (
                <ClassContract params={params} detailClass={detailClass} />
              ) : null}
              {tabSearchParam === "class-lecturer" ? (
                <ClassLecturer params={params} />
              ) : null}
              {tabSearchParam === "class-schedule" ? (
                <ClassSchedule classId={classId} searchParams={searchParams} />
              ) : null}
            </CardBody>
          </Card>
        </Col>
